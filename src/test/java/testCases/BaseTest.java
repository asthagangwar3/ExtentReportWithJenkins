...
public void initializeReport(){
    ...
    extent.attachReporter(htmlReporter);   htmlReporter =  new ExtentHtmlReporter(System.getProperty("user.dir")+"/Reports/extentReport.html");
    htmlReporter.config().setDocumentTitle("Automation Report");
    htmlReporter.config().setReportName("report");
    htmlReporter.config().setTheme(Theme.STANDARD);
    extent =new ExtentReports();
    ...
    public static String CaptureScreenshot(WebDriver driver) throws IOException {
        ...
        screenshotName = "screenshot"+Math.random()+".png";
        screenshotpath = ScreenshotPAth+FileSeparator+screenshotName;
